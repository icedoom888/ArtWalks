...
# FOLDER_NAME=$2
# OUTPATH=$3
# S=$4 NUMBER OF DIFFUSION IMAGES
# I=$5 SECONDS BETWEEN IMAGES
# F=$6 SECONDS OF FREEZING ORIGINAL FRAMES
# M=$7 MODEL CHOSEN


## MINE ##
# bash full_pipeline.sh stories Story_E_cropped /media/data-storage/iaivc 5 10 10 kandinsky
# bash full_pipeline.sh stories Story_F_cropped /media/data-storage/iaivc 5 10 10 kandinsky
# bash full_pipeline.sh stories Story_G_cropped /media/data-storage/iaivc 5 10 10 kandinsky
# bash full_pipeline.sh stories Story_H_cropped /media/data-storage/iaivc 5 9 10 kandinsky
# bash full_pipeline.sh stories Story_I_cropped /media/data-storage/iaivc 5 9 10 kandinsky
